...
def run_sim(type, 
    ...
    if to_simulate_form_rpt is True and to_follow_current is False:
    ...
    if to_simulate_form_aging is True and to_follow_current is False:
        # Formation Aging
    ...
    if to_simulate_cycling is True and to_follow_current is False:
...
def plot_diffusivity_heatmaps(diff_ec_vec, diff_vc_vec, mat1, mat2, mat3, label, is_error_plot=True, 
                              ...
                              to_show_tuned=True, is_log=True):
